 ...
 */
 ...
 TEST_CASE("bitmaps can be created and freed", "[bitmap]")
 {
     ...
     SECTION("can load and free multiple bitmaps")
     {
         ...
         {
             int width1 = 300, height1 = 42;
             int width2 = 35, height2 = 33;
             ...
             REQUIRE(bitmap_width(bmp1) == width1);
             REQUIRE(bitmap_height(bmp1) == height1);
             ...
             REQUIRE(bitmap_width(bmp2) == width2);
             REQUIRE(bitmap_height(bmp2) == height2);
